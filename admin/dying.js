...
(function () {
  ...
  var S = { doc: null, sha: null, repoOk: false, pending: false, saving: false, rev: 0, err: '', savedAt: null, timer: null, open: {}, tag: '' };
  var root, R = {};
  ...
  function renderOutline() {
    ...
    var rows = secs.map(function (s, i) {
      ...
      var notes = textIn(s.notes, 'Notes for ' + s.title, function (v) { s.notes = v; touch(s); }, { area: true, rows: 1, ph: 'Notes for yourself: what goes here (not counted)' });
